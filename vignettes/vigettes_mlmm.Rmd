--- 
title: "Introduction for mlmm package"
output: 
...
library(mlmm)
```
#4. Instructions and Examples of using main functions for regression, 
...
##4.2 R examples for using function mlmc() and mlmm()
###R examples for mlmc()
...
iterno=100,chains=2,savefile=TRUE,usefit=TRUE)
```
###Example 2b. Provide informative priors
...
https://www.biorxiv.org/content/early/2017/06/21/153049, editor.;
2017.
