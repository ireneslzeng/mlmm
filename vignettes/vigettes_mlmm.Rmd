...
#use the sampling to have 1000 posteror samples
...
#use an informative prior for alpha_prior which has a length of (1+number of predictors)
...
#use an informative prior for precision matrix for first level preditors
...
respond_dep_missing=TRUE,pidname="geneid",sidname="sid",prec_prior=prec_example,
iterno=100,chains=2,savefile=TRUE,usefit=FALSE)

#use the stan fit to have 1000 posterior samples
