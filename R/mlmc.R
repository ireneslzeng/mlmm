...
#'        formula format as lmr() and it is used to define the first level response 
#'        and its explanatory variables.
#'@param formula_missing  The logistic regression model formula; It has the same formula
#'        as formula_completed.
#'@param formula_censor The formula used in the program to define the observations with
#'    censored values.
#'@param formula_subject The second level formula in the multilevel model which is used to define
#'    responses such as subject and its explanatory variables.
...
#'    Missingness and censor are two different classifications, there should not have any overlap
#'    between missingness and censored.  Data structure can be referenced from the example and
#'    reference papers.
#'@param respond_dep_missing A logical variable to indicate whether response value is missing-
#'    dependant.
#'@param response_censorlim The detectable limit for the response value, i.e. 1 mg per Liter for
#'    intensity value.
#'@param pidname Variable name to define the multilevel response unit , i.e. protein name or gene
#'    name.
...
#'
#'
#'@return Return of the function is the result fitted by stan. It will have the summarized parameters
#'    from all chains and summary results for each chain. Plot function will return the visualization of
