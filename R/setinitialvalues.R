...
#'@return u_mean initial value of second level unit mean 
#'i.e. mean of protein abundance for protein 1
#'@return u_std initial value of second level unit standard deviation 
#'i.e. std of protein abundance for protein 1
